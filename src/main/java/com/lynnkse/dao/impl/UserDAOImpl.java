package com.lynnkse.dao.impl;

import com.lynnkse.dao.UserDAO;
import com.lynnkse.entity.User;
import com.lynnkse.util.HibernateUtil;
...
public class UserDAOImpl implements UserDAO {
    ...
    public List<User> getAllUsers(String userName) {
        ...
        for(Object[] userObject: userObjects) {
            ...
            int age = ((Integer)userObject[2]).intValue();
            boolean isAdmin = ((Boolean) userObject[3]).booleanValue();
